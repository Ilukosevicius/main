...
let editPostId = null
const API_ENDPOINTS = {
    post: 'https://testapi.io/api/Ignas1991/resource/newPosts',
    get: 'https://testapi.io/api/Ignas1991/resource/newPosts',
    getPostById: (id) => `https://testapi.io/api/Ignas1991/resource/newPosts/${id}`,
    edit: (id) => `https://testapi.io/api/Ignas1991/resource/newPosts/${id}`,
    delete: (id) => `https://testapi.io/api/Ignas1991/resource/newPosts/${id}`
}
